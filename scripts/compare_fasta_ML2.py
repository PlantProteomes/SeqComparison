# Margaret Li
# 12/17/21
# This program is a more efficient version of compare_fasta_ML.py. The
# main difference is that it uses dictionaries instead of lists to 
# compare plant sequences.
            ...
            for record in SeqIO.parse(infile, 'fasta'):
                ...
                if match:
                    ...
                    if identifier not in self.sequences:
                        self.identifiers[identifier] = 1 # add identifier and count to dict
                    else:
                        self.identifiers[identifier] += 1 # add identifier and count to dict
                else:
                    print(
